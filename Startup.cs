    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<IdentityOptions> (options => {
                ...
                options.Password.RequiredUniqueChars = 6; // Số ký tự riêng biệt

                // Cấu hình Lockout - khóa user
                options.Lockout.DefaultLockoutTimeSpan = TimeSpan.FromSeconds(30); // Khóa 30 giây nhẹ nhàng
                options.Lockout.MaxFailedAccessAttempts = 2; // Thất bại 2 lần thì khóa
